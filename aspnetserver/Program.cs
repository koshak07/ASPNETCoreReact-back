...
// Configure the HTTP request pipeline.
    ...
    {
        swaggerUiOptions.DocumentTitle = "React with ASP.NET";
        swaggerUiOptions.SwaggerEndpoint("/swagger/v1/swagger.json", "Web API very simple model");
...
app.MapGet("/get-all-posts", async () => await PostRepository.GetPostsAsync()).WithTags("Posts Endpoints");
...
app.MapPost("/create-post", async (Post postToCreate) =>
{
    ...
    else return Results.BadRequest("Error Creating post!");
...
app.MapPut("/update-post", async (Post postToUpdate) =>
{
    ...
    else return Results.BadRequest("Error Update post!");
...
app.MapDelete("/delete-post-by-id/{postId}", async (int postId) =>
{
    ...
    else return Results.BadRequest("Error Delete post!");
